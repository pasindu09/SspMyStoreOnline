...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
       ...
       class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-base font-medium leading-5 text-gray-800 hover:text-black hover:border-blue-500 focus:outline-none focus:border-gray-300 transition duration-150 ease-in-out"
    >Admin Dashboard</a>
...
<div class="container mt-10 mx-auto">
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-10">
    ...
    <div class="bg-white rounded-lg shadow-xl p-6 flex items-center justify-center">
      ...
      <div>
        <h2 class="text-lg font-semibold mb-2">Total Sellers</h2>
    ...
    <div class="bg-white rounded-lg shadow-xl p-6 flex items-center justify-center">
      ...
      <div>
        ...
        <p class="text-2xl text-blue-600">4</p>
      </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-xl p-6 flex items-center justify-center">
      ...
      <div>
        ...
        <p class="text-2xl text-blue-600">9</p>
      </div>
    </div>
  ...
  <div class="mt-8 bg-white rounded-lg shadow-xl p-6 text-center">
    ...
    <p>Additional content and details for the Admin overview.</p>
  </div>
</div>
