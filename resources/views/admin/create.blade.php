...
<body>
    ...
    <a href="{{ url('/users/create') }}"> <button x-on:click="openModal = true" class="px-3 py-1 rounded-full bg-blue-500 text-white hover:bg-blue-700 transition duration-200">Create User</button></a>
