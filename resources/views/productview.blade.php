<x-home-layout>
    ...
    <div style="height: 70vh;" class="h-40 flex mt-12 border">
        <div style="width: 40%; display:flex; align-items: center; justify-content: center;" class="border ml-12">
        ...
        <div style="width: 60%;" class="flex flex-col ml-12">
            ...
            <div class="flex items-center py-4">
                ...
                <form id="addtocartForm" method="POST" action="{{ url('/products/itemadd2/' . $product->id . '/' . $product->id) }}">
                    ...
                    <button id="addtocart" type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 border border-black-100 rounded shadow">Add To Cart</button>
                </form>
                @endif
                @if($quantity)
                ...
                <form method="POST" action="{{ url('/products/itemremove/' . $quantity->id . '/' . $quantity->id) }}">
                    @csrf
                    <button id="remove" type="submit" class="bg-red-500 hover:bg-red-700 text-white font-semibold py-2 px-4 border border-black-100 rounded shadow">Remove From Cart</button>
                </form>
