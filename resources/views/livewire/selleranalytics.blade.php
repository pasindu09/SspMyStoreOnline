        ...
        <div class="text-white">
            <div class="flex p-2  bg-gray-800">
                <div class="flex py-3 px-2 items-center">
                    <p class="text-2xl text-blue-500 font-semibold">MyStore</p> <p class="ml-2 font-semibold italic">
                    online</p>
                </div>
            </div>
            <div class="flex justify-center">
                <div class="">
                    <img class="hidden h-24 w-24 rounded-full sm:block object-cover mr-2"
                        src="{{ asset('image/logo_transparent.png') }}" alt="">
                </div>
            </div>
            <div>
